  ...
  return (
    ...
    >
      ...
      {showProfile ? (
        ...
        >
          <span style={{ fontWeight: 600, fontSize: 13, color: 'var(--ink-2)' }}>DR. DESAI</span>
          <div
            style={{
              width: 32,
              height: 32,
  ...
  return (
    ...
    >
      <span style={{ position: 'relative', display: 'inline-block' }}>
        ...
        <span style={{ fontSize: size * 0.6, color: 'var(--butter)', marginLeft: 4, fontFamily: "'JetBrains Mono', monospace" }}>
          //OS
        </span>
      </span>
    </div>
